...
<p class="text-danger">If you run a website, and under SSL, read this section ...</p>
...
<p class="text-danger">If you own a computer, or mobile device, or an internet enabled fridge, you really want to read this too:</p>
