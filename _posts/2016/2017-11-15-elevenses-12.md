...
* [Spot the difference: automating visual regression testing (slides)](https://www.slideshare.net/vivrichards/spot-the-difference-automating-visual-regression-testing/1) [(code)](https://github.com/vivrichards600/AutomatedVisualTesting)
...
* [The Power of Mentoring (slides)](https://www.slideshare.net/secret/9MbOc51EzSTP8N)
* [What is the point of Microsoft (slides)](https://github.com/westleyl/DDDNorth2017)
...
* [GeoIP - get more country code info from an IP address](https://betalist.com/startups/user-country-api)

## UI & UX
* [Material Palette](https://www.materialpalette.com/) - *(Pick main two colours, and download the theme)*
* [Little design tips](https://twitter.com/i/moments/880688233641848832), by [@steveschoger](https://twitter.com/steveschoger)
...
* [A couple of free icon sets](https://twitter.com/Real_CSS_Tricks/status/929000703384625152)
* [Bootstap 12 column grid in 5 lines of CSS #grid](https://twitter.com/wesbos/status/928731575684091904)
...
* [Convert JavaScript into an SVG flowchart](https://github.com/Bogdan-Lyashenko/js-code-to-svg-flowchart) *- dunno why, it's just cool :)*
* [Cloudflare uses LavaLamps for randomness!](https://youtu.be/1cUUfMeOijg)
* [Your own Jarvis, at home](https://duo.computer/index.html)
...
* [Dynamically Generated Alt Text](https://s.codepen.io/sdras/debug/4437473c764a1d553691005a0f40a145) *(sadly the quota has been maxed out at the moment)*
